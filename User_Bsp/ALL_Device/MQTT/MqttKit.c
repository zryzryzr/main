...
void MQTT_NewBuffer(MQTT_PACKET_STRUCTURE *mqttPacket, uint32 size)
{
	...
	{
		mqttPacket->_memFlag = MEM_FLAG_ALLOC; // 1����̬�����ڴ�

		mqttPacket->_data = (uint8 *)MQTT_MallocBuffer(size);

		// malloc(size)��malloc �� C ��׼���еĺ��������Ӷ��з���һ���СΪ size �ֽڵ��ڴ棬
		// ������һ��ָ����ڴ���ָ�롣�������ʧ�ܣ����᷵�� NULL��
	...
	{
		mqttPacket->_memFlag = MEM_FLAG_STATIC; // 2����̬�����ڴ�
...
/*
������� MQTT_DumpLength �Ĺ����ǽ�һ������ֵ��len������ MQTT Э��Ŀɱ䳤�ȱ����ʽ
��Variable Length Encoding�����뵽һ����������buf���У������ر���ʹ�õ��ֽ�����
MQTT Э��ʹ�����ֱ��뷽ʽ����ʾĳЩ�ֶΣ�������Ϣ���ܳ��ȣ����Ա��ø��ٵ��ֽڱ�ʾ��С�����֣�
ͬʱ�������������ռ�ö���ֽڡ�
*/
/*
����
...
len = 300
���� 300 % 128 = 44���� 44 �����һ���ֽڡ�
���� len >>= 7���õ� 300 / 128 = 2��ʣ��ĳ��ȣ���
��Ϊ len > 0���������λΪ 1����һ���ֽ�Ϊ 44 | 128 = 172��
�ڶ�����

len = 2
���� 2 % 128 = 2���� 2 ����ڶ����ֽڡ�
���� len >>= 7���õ� 2 / 128 = 0�����ȴ�����ϣ���
��Ϊ len == 0���������λΪ 0���ڶ����ֽ�Ϊ 2��
���գ�300 ������Ϊ�����ֽڣ�

��һ���ֽ�Ϊ 172��0b10101100����
�ڶ����ֽ�Ϊ 2��0b00000010����
*/
...
/*
���� MQTT_ReadLength ���ڴ��������ж�ȡһ��ʹ�� MQTT Э��Ŀɱ䳤�ȱ����ʽ����ĳ���ֵ��
stream��ָ����������ָ�룬�����˴���ȡ�Ŀɱ䳤�ȱ������ݡ�
size���������Ĵ�С���ֽ�������
len��ָ��һ�� uint32 ������ָ�룬���ڴ洢�����ĳ���ֵ��
����ֵ���ɹ�ʱ���ض�ȡ���ֽ�����ʧ��ʱ���ش����루�� -1 ��ʾ��������-2 ��ʾ������Χ����

MQTT_ReadLength ������֮ǰ�� MQTT_DumpLength �����������෴�Ĳ�����
*/
...
//				devid���豸ID
//				cTime�����ӱ���ʱ��
//				clean_session��������Ϣ�����־��Ϊ1�Ļ���ֻ��ʵʱ��֮ǰû����ĻỰ��ɾ��
//				qos���ط���־
//				will_topic���쳣����topic
//				will_msg���쳣������Ϣ
//				will_retain����Ϣ���ͱ�־
